...
public class Algorithms {
    ...
    public static <V, E> E shortestPathWithAutonomy(Graph<V, E> g, V vOrig, V vDest,
        ...
        // Run Dijkstra's algorithm
        shortestPathDijkstraWithAutonomy(g, vOrig, ce, sum, zero, visited, pathKeys, dist, infinity, autonomy);
    ...
    private static <V, E> void shortestPathDijkstraWithAutonomy(Graph<V, E> g, V vOrig,
                                                    Comparator<E> ce, BinaryOperator<E> sum, E zero,
