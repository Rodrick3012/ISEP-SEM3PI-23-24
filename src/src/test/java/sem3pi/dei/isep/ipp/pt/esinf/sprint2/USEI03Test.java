...
public class USEI03Test {
    ...
    public void testShortestPathWithVariousAutonomy(){
        ...
        // Test for 400 km of autonomy

        ShortestPath shortestPathValues =usei03.getShortestPathBetweenTwoMostRemoteLocals(400);
        ...
        assertEquals(Optional.of(530), Optional.of(shortestPathValues.getTotalDistance()));
        assertEquals(Optional.of(1), Optional.of(shortestPathValues.getRefuelingPoints()));

        // Test for 0 km of autonomy

        ShortestPath shortestPathValues1 =usei03.getShortestPathBetweenTwoMostRemoteLocals(0);
        ...
        // Test for 1000 km of autonomy

        ShortestPath shortestPathValues2 = usei03.getShortestPathBetweenTwoMostRemoteLocals(1000);
        ...
        assertEquals(Optional.of(646), Optional.of(shortestPathValues2.getTotalDistance()));
