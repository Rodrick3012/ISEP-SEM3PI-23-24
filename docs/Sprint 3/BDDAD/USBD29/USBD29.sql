...
CREATE TABLE Unidade (
  id         number GENERATED AS IDENTITY, 
  designacao varchar2(10) NOT NULL UNIQUE, 
  PRIMARY KEY (id));
...
ALTER TABLE Quantidade ADD CONSTRAINT FKQuantidade768256 FOREIGN KEY (cultura) REFERENCES Cultura (id);
ALTER TABLE Quantidade ADD CONSTRAINT FKQuantidade252813 FOREIGN KEY (unidade) REFERENCES Unidade (id);
